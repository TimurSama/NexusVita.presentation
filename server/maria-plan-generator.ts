...
export async function createMariaPlan(userId: number) {
  ...
  const weeklyPlan = {
    ...
    tuesday: [
      ...
      { time: '07:10', title: 'Растяжка подколенных сухожилий', description: 'Сидя на краю стула, выпрямите одну ногу вперед. Наклонитесь к ноге, чувствуя растяжение в задней части бедра. Держите 15 секунд, поменяйте ногу. Это помогает снять напряжение с седалищного нерва', category: 'movement' },
      ...
      { time: '20:00', title: 'Растяжка ягодиц и тазобедренных мышц', description: 'Сидя на стуле, положите одну ногу на колено другой. Наклонитесь вперед, чувствуя растяжение в ягодице и тазобедренной области. Держите 20 секунд, поменяйте ногу', category: 'movement' },
      { time: '21:00', title: 'Самомассаж', description: 'Лёгкий самомассаж бёдер (спина и ягодицы) с маслом. Особое внимание уделите области седалищного нерва (задняя часть бедра и ягодицы)', category: 'movement' },
    ],
    wednesday: [
      { time: '07:00', title: 'Растяжка тазобедренных сгибателей', description: 'Стойка в выпаде вперед, держать по 20 сек на каждую ногу. Важно: передняя нога согнута, задняя прямая, чувствуйте растяжение в передней части бедра задней ноги', category: 'movement' },
      { time: '07:10', title: 'Растяжка седалищного нерва (сидя)', description: 'Сидя на стуле, выпрямите одну ногу вперед. Наклонитесь к ноге, чувствуя растяжение в задней части бедра. Держите 15-20 секунд, поменяйте ногу. Выполняйте плавно, без резких движений', category: 'movement' },
      ...
      { time: '20:00', title: 'Растяжка грушевидной мышцы', description: 'Лежа на спине, согните одну ногу и положите лодыжку на колено другой. Мягко подтяните колено к груди, чувствуя растяжение в ягодице. Держите 20-30 секунд, поменяйте ногу. Это упражнение особенно важно для седалищного нерва', category: 'movement' },
      { time: '20:15', title: 'Вытяжение боков', description: 'Стоя широко, кисти на бёдрах, наклоны влево-вправо (по 10 раз, держать 5 сек внизу)', category: 'movement' },
    ...
    thursday: [
      ...
      { time: '07:10', title: 'Растяжка сгибателей бедра', description: 'Встаньте в выпад, передняя нога согнута, задняя прямая. Наклонитесь вперед, чувствуя растяжение в передней части бедра задней ноги. Держите 20 секунд, поменяйте ногу. Это упражнение критически важно для тазобедренных мышц', category: 'movement' },
      ...
      { time: '20:00', title: 'Растяжка "бабочка"', description: 'Сидя, соедините подошвы ног и руками тянитесь к ступням (20 секунд). Это упражнение растягивает внутренние мышцы бедра и тазобедренной области', category: 'movement' },
      { time: '20:15', title: 'Растяжка седалищного нерва (лежа)', description: 'Лежа на спине, поднимите одну прямую ногу вверх. Мягко потяните ее к себе, чувствуя растяжение в задней части бедра. Держите 20-30 секунд, поменяйте ногу. НЕ делайте резких движений!', category: 'movement' },
      { time: '21:00', title: 'Массаж стенки таза', description: 'Лежа на спине массируйте мягко бока таза круговыми движениями. Также массируйте область ягодиц, где проходит седалищный нерв', category: 'movement' },
    ],
    friday: [
